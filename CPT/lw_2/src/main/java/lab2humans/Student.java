...
public class Student extends UniversityMember {
    ...
    public void setMajor(String major){ if(major==null||major.isBlank()) throw new IllegalArgumentException("Специальность пустая"); this.major=major; }
    public double getGpa(){ return gpa; }
    public void setGpa(double gpa){ if(gpa<0||gpa>5) throw new IllegalArgumentException("GPA 0..5"); this.gpa=gpa; }
    public int getYear(){ return year; }
    public void setYear(int year){ if(year<=0) throw new IllegalArgumentException("Курс > 0"); this.year=year; }
