...
public class TeachingAssistant extends UniversityMember {
    ...
    public TeachingAssistant(){ this("Анна Соколова",22,"TA-3001","МГУ","anna.sоколова@example.com",2022,"Алгоритмы","Сергей Смирнов",30000); }
    ...
    public void setAssignedCourse(String assignedCourse){ if(assignedCourse==null||assignedCourse.isBlank()) throw new IllegalArgumentException("Курс пустой"); this.assignedCourse=assignedCourse; }
    public String getSupervisor(){ return supervisor; }
    public void setSupervisor(String supervisor){ if(supervisor==null||supervisor.isBlank()) throw new IllegalArgumentException("Руководитель пустой"); this.supervisor=supervisor; }
    public double getStipend(){ return stipend; }
    public void setStipend(double stipend){ if(stipend<0) throw new IllegalArgumentException("Стипендия >= 0"); this.stipend=stipend; }
